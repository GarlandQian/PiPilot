...
The actual first trigger may therefore be an SDK runtime failure, extension
binding/shutdown, event/UI projection failure, bounded flow-control failure,
request timeout, or transport failure. None is yet proven.

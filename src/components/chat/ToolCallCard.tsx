    ...
    <Collapsible open={open} onOpenChange={setOpen}>
      <div className="min-w-0" data-tool-kind={call.kind} data-tool-id={call.id}>
        <CollapsibleTrigger asChild>
          <button
            type="button"
            className="flex h-[var(--tool-row-h)] w-full cursor-pointer items-center gap-2 rounded-sm px-1.5 text-left outline-none transition-colors duration-(--duration-fast) hover:bg-accent/30 focus-visible:focus-ring motion-reduce:transition-none"
            aria-expanded={open}
          >
